...
> 📖 **See also**: [CI/CD Setup Guide](../CI-CD-SETUP.md) for GitHub Actions automation
...
GitHub Actions workflows have been set up for automated deployment:
...
### Setup Required
1. Get Vercel credentials (Token, Org ID, Project ID)
2. Add secrets to GitHub repo settings
3. Push to `main` to trigger deployment

**📖 Full instructions**: See [CI/CD Setup Guide](../CI-CD-SETUP.md)
